...
function LandingNavbar() {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <nav className="z-10 md:bg-[#4A4A4A] mt-2 md:mt-5 w-[98%] rounded-md items-center justify-between text-[0.75rem] lg:text-sm font-semibold text-white flex py-2">
        ...
        <div className="md:flex w-[90%] justify-evenly items-center hidden">
          <div className="flex gap-[2rem] justify-center items-center w-[80%]">
            <Link href="#home">
              <p
                onClick={sendMail}
                className="hoverUnderline hover:text-[#3572EF]"
              >
                Home
              </p>
            </Link>
            ...
            <Link
              href="#benefits"
            >
              <p className="hoverUnderline hover:text-[#3572EF]">Benefits</p>
            </Link>

            <Link href="#offer">
              <p className="hoverUnderline hover:text-[#3572EF]">
                What we offer
              </p>
            </Link>
            ...
            <Link href="/support">
              <p className="hoverUnderline hover:text-[#3572EF]">Get Help</p>
            </Link>

            {authenticatedForDashboard ? (
              <Link href="/dashboard">
                <p className="hoverUnderline hover:text-[#3572EF]">Dashboard</p>
              </Link>
            ) : (
              <></>
            )}
          ...
          <div className="mr-4">
            ...
            {isAuthenticated ? (
              ...
              >
                ...
                >
                  <div className="flex items-center p-3 border-b-2 border-b-[#3572EF] justify-left">
                    <Image
                      loader={myLoader}
                      src={`https://api.dicebear.com/7.x/initials/svg?seed=${user?.firstName}`}
                      width={10}
          ...
          >
            <div className="flex flex-col gap-[2rem]  w-[80%]">
              <Link href="/">
                <p className="hoverUnderline hover:text-[#3572EF]">Home</p>
              </Link>
