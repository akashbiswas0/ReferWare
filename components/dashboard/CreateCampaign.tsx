      ...
      <div className={`w-[98%] flex gap-2 py-6 pl-4`}>
        <div className="w-[50%] text-white flex flex-col gap-4">
          ...
          <button
            ...
            className="py-3 bg-[#3572EF] text-white text-sm text-center w-[35%] rounded-lg cursor-pointer"
          >
            Create Campaign
          </button>
        </div>
        <div className="w-[50%] rounded-2xl bg-[#2855b1] flex justify-center items-center h-[90vh]"></div>
      </div>
    </>
  );
}
